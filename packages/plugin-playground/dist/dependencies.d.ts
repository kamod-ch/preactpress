...
export declare function createDependencyContext(
  options?: PlaygroundPluginOptions,
): DependencyContext;
/** Resolve user-declared dependencies into an import map for the sandbox iframe. */
export declare function resolveImportMap(
...
export declare function findDisallowedImports(
  source: string,
