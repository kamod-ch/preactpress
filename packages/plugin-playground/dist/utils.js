...
export function buildStackBlitzUrl(options) {
    ...
    const pkg = {
        ...
        dependencies: {
            preact: "^10.29.2",
            ...Object.fromEntries(Object.entries(dependencies).filter(([name]) => name !== "preact" && name !== "preact/hooks")),
        },
    };
...
export function previewWidthPx(width) {
    switch (width) {
        case "mobile":
            return 390;
        case "tablet":
...
export function isDarkPreviewTheme(theme) {
    return theme === "dark";
}
