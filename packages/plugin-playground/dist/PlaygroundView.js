...
export function PlaygroundView(props) {
  ...
  return _jsxs("section", {
    class: "pp-playground",
    "aria-label": title,
    "data-pp-playground": "interactive",
    children: [
      _jsxs("div", {
        class: "pp-playground-toolbar",
        role: "toolbar",
        "aria-label": "Playground controls",
        children: [
          _jsxs("div", {
            class: "pp-playground-toolbar-group",
            children: [
              _jsx("button", {
                type: "button",
                class: "pp-playground-btn",
                onClick: resetFiles,
                disabled: readOnly,
                children: "Reset",
              }),
          ...
          _jsx("div", {
            ...
            children: ["desktop", "tablet", "mobile"].map((width) =>
              _jsx(
                "button",
                {
                  type: "button",
      ...
      _jsxs("div", {
        class: "pp-playground-body",
        children: [
          _jsxs("div", {
            class: "pp-playground-editor-pane",
            children: [
              filePaths.length > 1
                ? _jsx("div", {
                    class: "pp-playground-tabs",
                    role: "tablist",
                ...
                : null,
              _jsx("label", {
                class: "pp-playground-editor-label",
                for: editorId,
                children: activeFile.replace(/^\//, ""),
              }),
              _jsx(
                "textarea",
                {
          ...
          _jsxs("div", {
            class: "pp-playground-preview-pane",
            children: [
              _jsx("div", { class: "pp-playground-preview-label", children: "Preview" }),
              _jsx("div", {
      ...
      error ? _jsx("pre", { class: "pp-playground-error", role: "alert", children: error }) : null,
    ],
  });
}
