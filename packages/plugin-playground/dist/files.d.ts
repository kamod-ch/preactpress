...
export declare function resolvePlaygroundFiles(props: Pick<PlaygroundProps, "code" | "files" | "entry">): ResolvedPlaygroundState;
/** Merge user dependencies with defaults required for Preact TSX examples. */
export declare function mergeDependencies(user: PlaygroundDependencies | undefined, defaults?: PlaygroundDependencies): PlaygroundDependencies;
