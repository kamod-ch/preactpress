import type { ChangelogSection, ChangelogSectionKind, RawChangelogRelease } from "../types/index.js";
...
export declare function normalizeRawRelease(raw: RawChangelogRelease, route: string, slug: string): {
    version: string;
    slug: string;
    route: string;
...
export declare function releaseMatchesDocVersion(releaseVersion: string, docVersion: string): boolean;
