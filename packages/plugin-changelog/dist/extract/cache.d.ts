...
export declare function readManifestCache(
  options: ChangelogCacheOptions,
  sourceHash: string,
): Promise<ChangelogManifest | undefined>;
export declare function writeManifestCache(
  options: ChangelogCacheOptions,
  sourceHash: string,
  manifest: ChangelogManifest,
): Promise<void>;
export declare function readRemoteCache<T>(
  cacheDir: string,
  provider: string,
  key: string,
): Promise<
  | (ChangelogRemoteCacheRecord & {
      payload: T;
    })
  | undefined
>;
export declare function writeRemoteCache(
  cacheDir: string,
  provider: string,
  key: string,
  record: Omit<ChangelogRemoteCacheRecord, "fetchedAt"> & {
    payload: unknown;
  },
): Promise<void>;
