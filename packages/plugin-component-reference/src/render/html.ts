...
function renderPropRow(prop: ComponentProp): string {
...
export function renderComponentReferenceHtml(entry: ComponentEntry): string {
...
export function componentSearchTags(entry: ComponentEntry): string[] {
  return [...new Set(entry.tags)];
}

export function lookupComponent(
  manifest: ComponentManifest,
  lookup: { component?: string; source?: string; exportName?: string },
