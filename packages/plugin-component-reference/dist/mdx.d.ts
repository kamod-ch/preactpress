...
export declare function ComponentReference(props: ComponentReferenceProps): import("preact").JSX.Element;
...
export declare function createComponentReferenceComponents(manifest: ComponentManifest): {
    ComponentReference: (props: Omit<ComponentReferenceProps, "manifest">) => import("preact").JSX.Element;
};
