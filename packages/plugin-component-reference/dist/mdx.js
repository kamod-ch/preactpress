...
export function ComponentReference(props) {
  ...
  if (!props.manifest) {
    return _jsxs("p", {
      class: "pp-component-reference-error",
      role: "alert",
      children: [
        "Pass a generated manifest via ",
        _jsx("code", { children: "createComponentReferenceComponents(manifest)" }),
        ".",
      ],
    });
  }
  if (!entry) {
    return _jsxs("p", {
      ...
      children: [
        ...
        " ",
        _jsx("code", { children: props.component ?? props.exportName ?? "unknown" }),
        ".",
      ],
    });
  }
