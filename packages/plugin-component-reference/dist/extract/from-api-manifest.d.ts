...
export declare function componentsFromApiManifest(manifest: ApiManifest): Record<string, ComponentEntry>;
export declare function mergeComponentManifests(base: ComponentManifest, extra: Record<string, ComponentEntry>): ComponentManifest;
