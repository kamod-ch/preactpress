...
export declare function readCache(options: OpenApiCacheOptions, sourceHash: string): Promise<OpenApiManifest | undefined>;
export declare function writeCache(options: OpenApiCacheOptions, sourceHash: string, manifest: OpenApiManifest): Promise<void>;
