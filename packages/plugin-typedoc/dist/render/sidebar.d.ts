...
export declare function mergePathSidebar(existing: SidebarGroup[] | Record<string, SidebarGroup[]> | undefined, baseRoute: string, generated: SidebarGroup[]): SidebarGroup[] | Record<string, SidebarGroup[]>;
