...
> **Note**
> `preactpress init` copies the built-in starter template and writes `preactpress` to `devDependencies`. You do not need to install PreactPress separately before running the initializer.
