...
describe('shouldIgnoreDeadLink', () => {
  ...
  it('matches glob patterns against href and route', () => {
    ...
    expect(shouldIgnoreDeadLink('/wip/page', ignore, { from: 'index.md', route: '/wip/page' })).toBe(true)
    expect(shouldIgnoreDeadLink('/draft/a/b', ignore, { from: 'index.md', route: '/draft/a/b' })).toBe(true)
    expect(shouldIgnoreDeadLink('/missing', ignore, { from: 'index.md', route: '/missing' })).toBe(false)
  })
