...
const FeatureCard: React.FC<{
  ...
  return (
    ...
    >
      ...
      />
      <div style={{ fontSize: 42, fontWeight: 800, color: palette.text, marginBottom: 18 }}>
        {title}
      </div>
    ...
    >
      ...
      <Sequence from={118} durationInFrames={200}>
        <AbsoluteFill style={{ padding: "120px" }}>
          ...
          <div style={{ fontSize: 30, color: "rgba(248,250,252,0.78)", marginBottom: 46 }}>
            Position the product clearly: write in Markdown, add Preact components, ship polished
            docs with a lightweight stack.
          </div>
      ...
      <Sequence from={330} durationInFrames={120}>
        ...
        >
          ...
          >
            Swap in your release message, feature highlights and call-to-action — then export an MP4
            with Remotion.
          </div>
          <div
            style={{
